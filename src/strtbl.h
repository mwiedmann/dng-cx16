...
#define GAME_MSG_LENGTH 16

#define STRING_COUNT INSTR0_LENGTH + INSTR1_LENGTH + INSTR2_LENGTH + INSTR3_LENGTH + STAT_SHEET_LENGTH + INSTR_SELECT_LENGTH + INSTR_CONTROLS_LENGTH + BOOSTS_LENGTH + GAME_MSG_LENGTH
