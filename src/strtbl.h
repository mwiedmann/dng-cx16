...
#define STRING_COMPOSITE_START STRING_STAT_SHEET_START + STAT_SHEET_LENGTH
#define COMPOSITE_ADJUST_LENGTH 9

#define STRING_INSTR_CONTROL_SCHEME_START STRING_COMPOSITE_START + COMPOSITE_ADJUST_LENGTH
...
#define INSTR_CONTROLS_LENGTH 18
...
#define STRING_COUNT INSTR0_LENGTH + INSTR1_LENGTH + INSTR2_LENGTH + INSTR3_LENGTH + STAT_SHEET_LENGTH + COMPOSITE_ADJUST_LENGTH + INSTR_CONTROL_SCHEME_LENGTH + INSTR_SELECT_LENGTH + INSTR_CONTROLS_LENGTH + BOOSTS_LENGTH + GAME_MSG_LENGTH
