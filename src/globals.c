...
PlayerStats barbarianStats = { {1, 1, 1, 1, 1, 1}, 2, 5  /* 12-sec */,  6, 14 /* 24-sec */,  4, 1000, 150, 75, { 0, 0, 0, 1 } };
...
PlayerStats boostedBarbarianStats = { {1, 1, 1, 1, 1, 2}, 2, 5  /* 12-sec */, 8, 12 /* 30-sec */,  8, 1000, 150, 75, { 0, 0, 1, 1 } };
PlayerStats boostedMageStats =      { {1, 1, 1, 1, 2, 2}, 1, 7 /* 8.5-sec */, 8, 12 /* 30-sec */, 12,  750, 100, 50, { 0, 0, 0, 1 } };
PlayerStats boostedDruidStats =     { {1, 1, 1, 1, 2, 2}, 1, 5  /* 10-sec */, 6, 10 /* 26-sec */, 12,  900, 130, 65, { 0, 0, 1, 1 } };
PlayerStats boostedRangerStats =    { {1, 1, 1, 1, 2, 2}, 1, 4  /* 12-sec */, 6, 8 /* 30-sec */, 12,  800, 110, 55, { 0, 0, 1, 1 } };
